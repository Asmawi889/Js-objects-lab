...
game ['difficulty'] = 'hard', 'medium', 'easy'
...
*/
console.log('---------------------------------------------------------')
const pokemons= pokemon.filter(startpoki => {
  if(startpoki.starter === true)
  game.party.push(startpoki)
})
...
*/
console.log('---------------------------------------------------------')
pokemon.filter (pokie => {
  if(pokie.type === 'dragon')
    game.party.push(pokie)
...
*/
console.log('---------------------------------------------------------')
game.party.forEach((pokemonsname) => {
    console.log(pokemonsname.name)
});
...
*/
console.log('---------------------------------------------------------')
 pokemon.filter(startpoki => {
  if(startpoki.starter === true)
  console.log(startpoki.name)
})
